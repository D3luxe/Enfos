...
function DiffShowTooltip()
{
	$.DispatchEvent( "DOTAShowTitleTextTooltip", lumberText, "Difficulty!" );
}

function DiffHideTooltip()
{
...
function ToggleLockButton( onOrOff )
{
	var lockButton = $("#LockAndStartButton")
	lockButton.enabled = onOrOff
}

function ToggleLockButtonTrue(  )
{
	var lockButton = $("#LockAndStartButton")
...
function SendVotes( )
{
	...
	var bountySelected = root.FindChildTraverse("#bountyDropdown");
	var selectedText = bountySelected.GetSelected().id;
	extraBounty = selectedText.substring(6);

	if ($( "#KillsButton1" ).checked == true) {
		killsVoted = 0
	} else if ($( "#KillsButton2" ).checked == true) {
		killsVoted = 1
	} else if ($( "#KillsButton3" ).checked == true) {
		killsVoted = 2
	} else if ($( "#KillsButton4" ).checked == true) {
		killsVoted = 3
	} else if ($( "#KillsButton5" ).checked == true) {
		killsVoted = 4
	};

	

	if ($( "#ShareBounty" ).checked == true) {
		shareBounty = 1
	};

	if ($( "#AllRandom" ).checked == true) {
		allRandom = 1
	};
	...
	$.Msg('Sending vote: ', Players.GetLocalPlayer(),'-',killsVoted,'-',extraBounty,'-',shareBounty,'-',allRandom,'-',noItemSharing,'-v2');
